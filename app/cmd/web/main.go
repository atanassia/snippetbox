...
func main() {
	...
	dsn := flag.String("dsn", "root2:password@tcp(db_mysql)/snippetbox?parseTime=true", "MySQL data source name")
	...
	errorLog := log.New(os.Stderr, "[ERROR]\t", log.Ldate|log.Ltime|log.Lshortfile|log.Lshortfile)
